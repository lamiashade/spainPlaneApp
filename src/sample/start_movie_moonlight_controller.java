...
public class start_movie_moonlight_controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if(image_string.equals("moon")){
            ...
            Image im = new Image(getClass().getResource("resources/moon_light_photo.jpeg").toExternalForm());
            setPicture(im);
        }
    ...
    void go_toplayMovie(ActionEvent event) {
        ...
        Node scene = null;
        try {
            scene = FXMLLoader.load(getClass().getResource("play_movie_moonlight.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
