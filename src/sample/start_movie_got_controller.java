...
public class start_movie_got_controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if(image_string.equals("got")){
            ...
            Image im = new Image(getClass().getResource("resources/got_photo.jpg").toExternalForm());
            setPicture(im);
        }
    ...
    void go_toplayMovie(ActionEvent event) {
        ...
        Node scene = null;
        try {
            scene = FXMLLoader.load(getClass().getResource("play_movie_got.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
